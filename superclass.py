...
regressor_feature_cols = ['avg_pass_adjusted_yards_per_attempt_l5', 'avg_rushing_yards_per_attempt_l5', 'avg_turnovers_l5', 'avg_pass_adjusted_yards_per_attempt_allowed_l5', 'avg_rushing_yards_per_attempt_allowed_l5', 'avg_turnovers_forced_l5', 'avg_point_differential_l5', 'days_rest', 'elo_rating', 'rpi_rating','avg_point_differential_home','avg_point_differential_away']

xgb = XGBoost(da, regressor_target, regressor_feature_cols)
...
classifier_feature_cols = ['avg_points_scored_l5', 'avg_pass_adjusted_yards_per_attempt_l5', 'avg_rushing_yards_per_attempt_l5', 'avg_turnovers_l5', 'avg_penalty_yards_l5', 'avg_sack_yards_lost_l5', 'avg_points_allowed_l5', 'avg_pass_adjusted_yards_per_attempt_allowed_l5', 'avg_rushing_yards_per_attempt_allowed_l5', 'avg_turnovers_forced_l5', 'avg_sack_yards_gained_l5','days_rest','elo_rating', 'rpi_rating', 'avg_point_differential_home','avg_point_differential_away']
